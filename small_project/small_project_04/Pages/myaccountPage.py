...
class MyAccountPage():
    def __init__(self, driver):
        self.driver = driver
        self.my_account_title = self.driver.find_element(By.XPATH, Locators.myAccount_title_value_xpath).text
        self.wishlist_button = self.driver.find_element(By.XPATH, Locators.wishlist_xpath)
        self.orderhistory_button = self.driver.find_element(By.XPATH, Locators.orderhistory_xpath)
