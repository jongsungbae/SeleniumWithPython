...
class IndexPage():
    def __init__(self, driver):
        ...
        self.search_button = self.driver.find_element(By.CSS_SELECTOR, Locators.search_submit_value_cssSelector)
        self.signin_button = self.driver.find_element(By.XPATH, Locators.signin_button_value_xpath)
